...
declare namespace PouchDB {
  namespace Core {
      ...
      interface AllDocsResponseRow<Content> {
      ...
      interface AllDocsResponseErrorRow<Content> {
        key: DocumentKey;
        error: Error;
      }
      interface AllDocsResponse<Content extends {}> {
          ...
          rows: Array<AllDocsResponseRow<Content>>;
      }
      interface AllDocsWithKeysResponse<Content extends {}> {
          ...
          total_rows: number;
          update_seq?: number | string | undefined;
          rows: Array<AllDocsResponseRow<Content>|AllDocsResponseErrorRow<Content>>;
      }
...
/**
  ...
  interface Database<Content extends {} = {}> extends EventEmitter {
      ...
      /** If keys were provided, we might have error rows. */
      allDocs<Model>(options?: Core.AllDocsWithKeyOptions | Core.AllDocsWithKeysOptions):
          Promise<Core.AllDocsWithKeysResponse<Content & Model>>;

          /** Fetch all documents matching the given options. */
      allDocs<Model>(options?: Core.AllDocsWithinRangeOptions | Core.AllDocsOptions):
